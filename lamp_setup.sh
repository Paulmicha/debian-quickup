...
#
#   Symfony recommends Php >= 5.3.8, but as of 10/01/2012, the default debian sources will install Php 5.3.3-7+squeeze14
#   -> if Php-5.4 is needed, use the following script instead :
#   @see https://github.com/Paulmicha/debian-quickup/blob/master/lamp_setup_php54.sh
#
...
Drupal & Symfony friendly LAMP (Php 5.3) server quick setup shell script for local dev
Usage :
